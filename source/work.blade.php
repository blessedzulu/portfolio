...
<main class="relative z-10 bg-paper">
    <div class="mx-auto max-w-4xl px-6 sm:px-8 pt-14 sm:pt-20">
        ...
        @include('_partials.page-header', [
            'eyebrow' => 'Work',
            'title'   => "Things I've built,<br>and keep building.",
            'intro'   => 'Products I own, systems I\'ve built for clients, and open-source packages for the frameworks I use - ambitious websites, apps and systems, shipped end to end.',
